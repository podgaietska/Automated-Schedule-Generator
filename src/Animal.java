public class Animal {
  ...
  public Animal(long ID, String NAME, String SPECIES, String BEHAVIOR, int MEAL_PREPARATION_TIME, int TIME_TO_EAT)
      throws IllegalArgumentException {
    if (ID == 0 || NAME == null || SPECIES == null || BEHAVIOR == null || MEAL_PREPARATION_TIME == 0
        || TIME_TO_EAT == 0) {
